...
class TurretThing(Thing):
    def __init__(self, pixels: PixelBuf, turn_left_button: Debouncer, turn_right_button: Debouncer, trigger_button: Debouncer, logging=False):
